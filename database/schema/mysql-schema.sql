...
CREATE TABLE `tasks` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `category_id` bigint unsigned DEFAULT NULL,
  `recurring_task_id` bigint unsigned DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2026_07_11_151404_create_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2026_07_11_151409_create_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2026_07_11_164702_add_uuid_to_tables',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2026_07_12_235616_set_uuid_to_table_tasks',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2026_07_13_164615_create_recurring_tasks_table',4);
